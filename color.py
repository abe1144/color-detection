...
class ColorDetector:
    ...
    def classify_img(self, img):
        img_arr = self.img_format(img)
        centroid_lst = self.cluster(img_arr)
        color_lst = [self.classify(arr) for arr in centroid_lst]
        return color_lst